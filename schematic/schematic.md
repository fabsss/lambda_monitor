...
graph TD
    ...
    classDef kfzfzg fill:#f9f,stroke:#333,stroke-width:2px;
    ...
    subgraph Spannungsversorgung [1. Kfz-Spannungsversorgung 12V zu 5V]
        Kl15[T3 Zündungsplus Kl. 15]:::kfzfzg --> F1[F1: Sicherung 250mA flink]:::bauteil
    ...
    subgraph Signal_und_OpAmp [2. Lambdasonden-Eingang & OpAmp 3x]
        Sonde[T3 Lambdasonde Schwarzes Kabel]:::kfzfzg --> R1[R1: Eingangswiderstand 10 kOhm]:::schutz
